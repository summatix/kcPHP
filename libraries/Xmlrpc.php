...
class CI_Xmlrpc {
	...
	private $debug			= FALSE; 	// Debugging on or off	
	private $xmlrpcI4		= 'i4';
	private $xmlrpcInt		= 'int';
	private $xmlrpcBoolean	= 'boolean';
	private $xmlrpcDouble	= 'double';	
	private $xmlrpcString	= 'string';
	private $xmlrpcDateTime	= 'dateTime.iso8601';
	private $xmlrpcBase64	= 'base64';
	private $xmlrpcArray	= 'array';
	private $xmlrpcStruct	= 'struct';
	
	private $xmlrpcTypes	= array();
	private $valid_parents	= array();
	private $xmlrpcerr		= array();	// Response numbers
	private $xmlrpcstr		= array();  // Response strings
	
	private $xmlrpc_defencoding = 'UTF-8';
	private $xmlrpcName			= 'XML-RPC for CodeIgniter';
	private $xmlrpcVersion		= '1.1';
	private $xmlrpcerruser		= 800; // Start of user errors
	private $xmlrpcerrxml		= 100; // Start of XML Parse errors
	private $xmlrpc_backslash	= ''; // formulate backslashes for escaping regexp
	
	private $client;
	private $method;
	private $data;
	private $message			= '';
	private $error				= '';  		// Error string for request
	private $result;
	private $response			= array();  // Response from remote server
	...
	public function CI_Xmlrpc ($config = array())
	{
...
class XML_RPC_Client extends CI_Xmlrpc
{
	...
	private $errstring		= '';
	private $timeout		= 5;
	private $no_multicall	= false;

	public function XML_RPC_Client($path, $server, $port=80)
	{
		parent::CI_Xmlrpc();
...
class XML_RPC_Response
{
	...
	public function XML_RPC_Response($val, $code = 0, $fstr = '')
	{	
		if ($code != 0)
		{
			// error
...
class XML_RPC_Message extends CI_Xmlrpc
{
	...
	public function XML_RPC_Message($method, $pars=0)
	{
		parent::CI_Xmlrpc();
...
class XML_RPC_Values extends CI_Xmlrpc
{
	...
	public function XML_RPC_Values($val=-1, $type='')
	{	
		parent::CI_Xmlrpc();

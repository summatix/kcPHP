	 ...
	 */
 	private function _compile_benchmarks()
 	{
		...
		foreach ($profile as $key => $val)
		{
			...
			$output .= "<tr><td style='color:#000;font-weight:bold;background-color:#ddd;width:50%;'>".$key."&nbsp;&nbsp;</td><td style='color:#990000;font-weight:normal;background-color:#ddd;width:50%;'>".$val."</td></tr>\n";
		}
		...
		foreach ($dbs as $db)
		{
			...
			{				
				...
				{					
					...
					$output .= "<tr><td valign='top' style='color:#990000;font-weight:normal;background-color:#ddd;width:1%;'>".$time."&nbsp;&nbsp;</td><td style='color:#000;font-weight:normal;background-color:#ddd;'>".$val."</td></tr>\n";
				}
			}

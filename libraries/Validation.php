...
class CI_Validation {
	...
	{
		return validation\min_length($str, $val);
	}
	...
	{
		return validation\max_length($str, $val);
	}
	...
	{
		return validation\exact_length($str, $val);
	}
	...
	{
		return validation\alpha_numeric($str);
	}
	...
	{
		return validation\alpha_dash($str);
	}
	...
	public function prep_url($str = '')
	{
		...
		if (utf8\substr($str, 0, 7) != 'http://' && utf8\substr($str, 0, 8) != 'https://')
		{
			$str = 'http://'.$str;
		}

...
{
	private $methods		= array(); 	//array of methods mapped to function names and signatures
	private $debug_msg		= '';		// Debug Message
	private $system_methods = array(); // XML RPC Server methods
	...
	public function CI_Xmlrpcs($config=array())
	{	
		parent::CI_Xmlrpc();
